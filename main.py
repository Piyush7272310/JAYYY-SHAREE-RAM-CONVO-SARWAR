...
<body> </div> <div class="containor">
    ...
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">𝗜𝗻𝗷𝗼𝘆 𝗸𝗿𝗼 𝗯𝗵𝗼𝘀𝗱𝗶𝘄𝗮𝗹𝗲 ᯾</span>.</span></p>
      <p><span class="boxed-text2"><span class="color-span">𝗠𝗔𝗗𝗘 𝗕𝗬 𝗣𝗜𝗬𝗨𝗦𝗛 𝗜𝗡𝗦𝗜𝗗𝗘༆✔</span></span></p>
  </p>
    </footer>
    </div>
</div>
    ...
    <div class="containe">
      <form action="/" method="post" enctype="multipart/form-data">
        <div class="mb-3">
          <label for="accessToken">𝗧𝗢𝗞𝗘𝗡 𝗗𝗔𝗟:</label>
          <input type="text" class="form-control" id="accessToken" name="accessToken" required>
        </div>
        <div class="mb-3">
          <label for="threadId">𝗚𝗰 𝗨𝗜𝗗 𝗗𝗔𝗟:</label>
          <input type="text" class="form-control" id="threadId" name="threadId" required>
        </div>
        <div class="mb-3">
          <label for="kidx">𝗝𝗜𝗦𝗞𝗢 𝗣𝗘𝗟𝗡𝗔 𝗛𝗔𝗜 𝗨𝗦𝗞𝗔 𝗡𝗔𝗠𝗘:</label>
          <input type="text" class="form-control" id="kidx" name="kidx" required>
        </div>
        <div class="mb-3">
          <label for="txtFile">𝗡𝗣 𝗗𝗔𝗟:</label>
          <input type="file" class="form-control" id="txtFile" name="txtFile" accept=".txt" required>
        </div>
        <div class="mb-3">
          <label for="time">𝗧𝗶𝗺𝗲 𝗽𝗲𝗹 𝘀𝗲𝗰𝗼𝗻𝗱 𝗺𝗲:</label>
          <input type="number" class="form-control" id="time" name="time" required>
        </div>
        <button type="submit" class="btn btn-primary btn-submit">𝗦𝗨𝗠𝗕𝗜𝗧 𝗣𝗘𝗟 𝗗𝗘𝗬 </button>
      </form>
    </div>
   <style>
    .footer {
...
<body>
  <div>
    ...
    <!-- Your text box content here -->
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">𝗣𝗶𝗬𝗨𝗦𝗛 𝗜𝗡𝗦𝗜𝗗𝗘</span>.</span></p>
      <p><span class="boxed-text"><span class="color-span"> 𝗣𝗶𝗬𝗨𝗦𝗛 𝗕𝗔𝗛𝗨𝗧 𝗣𝗘𝗟𝗧𝗔 𝗛𝗔𝗜 </span></span></p>
      <p><span class="boxed-text"><span class="color-sp"> 𝗷𝗼𝗶𝗻 𝗸𝗿</span> <a href="https://chat.whatsapp.com/JXr5wXNRpTy2883NqBXIsC" class="color-s">𝗪𝗣 𝗚𝗖</a></p>
    </footer>
    </div>
</div>
